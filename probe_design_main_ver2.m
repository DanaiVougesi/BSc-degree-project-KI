function probe_design_main_ver2(FASTA_dir, Probelist, out_dir, max_probe_number)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 

% This script is written by Shigeaki Kanatani, Karolinska Institutet
  
% Contact: shigeaki.kanatani@ki.se
